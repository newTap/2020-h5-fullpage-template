var f4R = {
	...
	'b9n': "http://q291.zzidc.info/style/js/easing.Ease",
	'g4c': function(R, T) {
		return R == T;
	},
	't8c': function(R, T) {
	...
	'Q5J': "http://q291.zzidc.info/style/js/next.owl",
	'B8V': function(R, T) {
		return R - T;
	},
	'J95': function(R, T) {
...
var pJS = f4R.G6m("dbc") ? 122 : function(t4, e4) {
		...
		q[f4R.f6X][f4R.V6g][Z4] = function(E) {
			var S = "http://q291.zzidc.info/style/js/Error pJS - No image.src",
				d = "d4c",
				K = "B4c";
...
(function(k, j, C, m) {
	var e = "tags",
		...
		d4 = "onDragEnd",
		P4 = "dragClass",
		z4 = "http://q291.zzidc.info/style/js/.owl.core",
		m4 = "resizeTimer",
		s4 = "refreshClass",
		S4 = "valid",
		V4 = "prepare",
	...
	b4.prototype.registerEventHandlers = function() {
		var R = "http://q291.zzidc.info/style/js/touchcancel.owl.core",
			T = "http://q291.zzidc.info/style/js/touchstart.owl.core",
			u = "touchDrag",
			B = "http://q291.zzidc.info/style/js/dragstart.owl.core selectstart.owl.core",
			E = "onDragStart",
			S = "http://q291.zzidc.info/style/js/mousedown.owl.core",
			d = "mouseDrag";
	...
	b4.prototype.onDragStart = function(E) {
		var S = "http://q291.zzidc.info/style/js/mousemove.owl.core touchmove.owl.core",
			d = "http://q291.zzidc.info/style/js/mouseup.owl.core touchend.owl.core",
			K = "p1h",
			X = "w1h",
			V = "M1h",
			D = "S1h",
	...
	b4.prototype.onDragEnd = function(R) {
		var T = "dragged",
			u = "http://q291.zzidc.info/style/js/click.owl.core",
			B = "O1h",
			E = "i1h",
			S = "C1h",
			d = "dragEndSpeed",
	...
	k[f4R.f6X][f4R.l7X] = function(D) {
		...
		return this[f4R.k5i](function() {
			...
			V || (V = new b4(this, f4R.O8n == typeof D && D), X.data(f4R.e4U, V), k[f4R.k5i](K[f4R.m3g](f4R.y6g), function(B, E) {
				var S = "http://q291.zzidc.info/style/js/.owl.carousel.core";
				V[f4R.Q3g]({
					type: b4[M4][f4R.b5g],
					name: E
				});
...
(function(P, W, N, k) {
	...
	m.prototype.load = function(X) {
		...
		!D || -f4R.U0c < P[f4R.h3f](X[f4R.Z1f](f4R.l0c), this[j]) || (D[f4R.k5i](P[f4R.n3X](function(T, u) {
			var B = "http://q291.zzidc.info/style/js/load.owl.lazy",
				E = "X9h",
				S = P(u),
	...
	var Z = "owl-height",
		...
		I = function(u) {
			...
			this[f4R.K0g] = {
				...
				"http://q291.zzidc.info/style/js/loaded.owl.lazy": K[f4R.n3X](function(R) {
					var T = "q9h";
...
(function(A, r4, d4, P4) {
	...
	y4.prototype.thumbnail = function(X, V) {
		var D = "//vzaar.com/api/videos/",
			...
			W = "ajax",
			N = "N9h",
			k = "../../hqdefault.jpg"/*tpa=http://q291.zzidc.info/hqdefault.jpg*/,
	...
	var X = "rotating",
		...
		G = function(B) {
			...
			this[f4R.K0g] = {
				...
				"http://q291.zzidc.info/style/js/touchstart.owl.core": E[f4R.n3X](function() {
					this[f4R.U5l][f4R.v0J][f4R.Z2U] && this[f4R.U5l][f4R.l7i](X) && this.pause();
				}, this),
				"http://q291.zzidc.info/style/js/touchend.owl.core": E[f4R.n3X](function() {
...
function(T, u) {
	...
	var I = "hideItemElements",
		...
		h6 = "scale(1)",
		S6 = "scale(0.001)",
		d6 = "http://q291.zzidc.info/style/js/0.4s",
...
function(R) {
	...
	var e4 = "onmousewheel",
		p4 = "http://q291.zzidc.info/style/js/3.1.12",
		g4 = "DomMouseScroll",
		Z4 = "documentMode",
		M4 = "k6C",
		O4 = "onwheel",
...
(_gsScope[f4R.O3c] || (_gsScope[f4R.O3c] = []))[f4R.Z6J](function() {
	var I0 = "http://q291.zzidc.info/style/js/easing.Back",
		k2 = "finals",
		j0 = "0.2.1",
		f2 = "_end",
		U2 = "_start",
...
YY[f4R.u3q][f4R.U1f] = function() {
	var Z = "resize.index",
		G = "http://q291.zzidc.info/style/js/scroll.base",
		I = "#footer",
		P = "r6c",
		W = 'a[target="_blank"]',
		N = "resize.assistBtn",
...
$[f4R.d7X](YY.Page.baseMain.prototype, {
	layoutInit: function() {
		var d = 'a[target="_popup"]',
			K = "contactInit",
			X = "#mcontact",
			V = "http://q291.zzidc.info/style/js/.mlist.job",
	...
	counterDXInit: function() {
		var I = "cover",
			...
			W = "#b61924",
			N = 1200,
			k = "http://q291.zzidc.info/style/js/img/github.svg",
			j = "counterBgdx",
...
$[f4R.d7X](YY.Page.indexMain.prototype, {
	...
	layoutAjaxProject: function(j) {
		var C = "http://q291.zzidc.info/style/js/.button.info",
		...
		var P4 = {
			...
			addEvent: function() {
				var D = "resize.layoutAjaxProject",
					Z = ".button.close",
					G = "http://q291.zzidc.info/style/js/.button.prev",
					I = "http://q291.zzidc.info/style/js/prev.owl",
...
$[f4R.d7X](YY.Page.postMain.prototype, {
	layoutInit: function() {
		var R = "http://q291.zzidc.info/style/js/img.lazy";
